...
module play_note (
    ...
    input wire [2:0]  rythm,       // rythm is een getal van 1 tot 8 die zegt hoeveel halve tellen een toon duurt
  ...
  reg [17:0] threshold_switch = tune / 2;
  reg state;
  reg playing = 0;
