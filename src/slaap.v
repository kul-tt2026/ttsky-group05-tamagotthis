...
// --- Stap 2: klein kruisje (X) tekenen op specifieke pixels ---
wire is_slaap_pixel =
    (y[4:0] == 5'd14 &&  (x[4:0] == 5'd13 || x[4:0]== 5'd21 || x[4:0] == 5'd12 || x[4:0]== 5'd22)) ||
    (y[4:0] == 5'd15 && (x[4:0] == 5'd11 || x[4:0] == 5'd14 || x[4:0] == 5'd23 || x[4:0] == 5'd20));

// --- Combineren: kruis heeft voorrang op oog-gebied, oog-gebied op ROM ---
wire [1:0] pixel_value = is_slaap_pixel ? 2'b01 :               // zwart kruisje
